...
wk.register({
    d = {
        ...
        v = {
            name = 'Virtual edit',
            i = { function() vim.opt.virtualedit:append('insert') end, [[Append 'insert']] },
            I = { function() vim.opt.virtualedit:append('insert') end, [[Remove 'insert']] },
            a = { function() vim.opt.virtualedit:append('all') end, [[Append 'all']] },
            A = { function() vim.opt.virtualedit:append('all') end, [[Remove 'all']] },
        },
        b = {
            name = 'Brightness',
